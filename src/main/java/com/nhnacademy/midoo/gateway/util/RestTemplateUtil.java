...
public class RestTemplateUtil {
    ...
    public static <T> ResponseEntity<T> createQuery(RestTemplate restTemplate, String url, String port, String path,
                                                    HttpMethod method, String body, Class<T> clazz) {
        ...
        return restTemplate.exchange(url + ":" + port + path,  // 요청 URL
                method,                     // HTTP 메서드
                body2,                               // 요청 본문 데이터 (없음)
                clazz                        // 응답 데이터 타입
        );
    ...
    public static <T> ResponseEntity<T> createQuery(RestTemplate restTemplate, String url, String port, String path,
                                                    HttpMethod method, Class<T> clazz, Map<String, Object> params) {
        String clientId = System.getenv("client_secret");
